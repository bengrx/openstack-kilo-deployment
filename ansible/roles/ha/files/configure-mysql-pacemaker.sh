...
crm configure primitive p_fs_mysql ocf:heartbeat:Filesystem params device="/dev/drbd/by-res/mysql/0" directory="/var/lib/mysql" fstype="xfs" options="relatime" op start timeout="60s" op stop timeout="180s" op monitor interval="60s" timeout="60s"
