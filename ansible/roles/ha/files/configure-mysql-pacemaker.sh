...
crm configure primitive p_ip_mysql ocf:heartbeat:IPaddr2 \
...
crm configure primitive p_mysql ocf:heartbeat:mysql \
  params additional_parameters="--bind-address=$1" \
...
crm configure ms ms_drbd_mysql p_drbd_mysql \
